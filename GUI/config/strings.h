...
#define STR_SETTINGS_LABELS 			"Etykiety"
#define STR_SETTINGS_DAYS_TO_END 		"Dni do końca"
#define STR_SETTINGS_LABELS_RED 		"CZERWONA"
#define STR_SETTINGS_LABELS_YELLOW 		"ŻÓŁTA"
#define STR_SETTINGS_NETWORK			"SIEĆ"
#define STR_SETTINGS_NETWORKMSG_TITLE	"Wprowadź haslo:"
#define STR_SETTINGS_MSGBOX_TITLE		"Polączono już z wybraną siecią"
